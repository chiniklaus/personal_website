  ...
  return (
    <div className="section border-top contact">
      <div className="container">
        ...
        <div className="row d-flex justify-content-center mt-4">
          <h4 className="text-center">qiandayu20@gmail.com</h4>
        </div>
        <div className="row d-flex justify-content-center mt-4 mb-4">
          <a href="https://www.linkedin.com/in/dayu-qian/" className="iconLink pr-4"><MDBIcon fab icon="linkedin-in" size="2x"/></a>
          ...
          <a href="mailto:qiandayu20@gmail.com" className="iconLink"><MDBIcon icon="envelope" size="2x"/></a>
        </div>
        <div className="row">
        </div>
      </div>
